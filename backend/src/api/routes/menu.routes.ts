...
import { extractInstituteData, requireRole, softAuthenticate } from '../../middleware/institute.middleware';
...
router.get('/categories', softAuthenticate, controller.get_categories); // Anyone can read
...
router.get('/items', softAuthenticate, controller.get_items); // Anyone can read
